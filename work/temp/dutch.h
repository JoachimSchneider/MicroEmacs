/*  NEDERLANDS.H:   Dutch language text strings for MicroEMACS 4.00
 *
 *                       Translated by Paul De Bra debra@research.att.com
...
#define TEXT90  \
    "(Y)Ja, (N)ee, (!)Doe rest, (U)Ongedaan, (^G)Breek af, (.)Stop, (?)Help: "
...
#define TEXT128 \
    "(e)val, (c/x)ommando, (t)Volg, (^G)breek af, <SP>doe, <META> stop debug"
