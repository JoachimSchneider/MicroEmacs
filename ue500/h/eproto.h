...
extern int PASCAL NEAR trRegIndent(int f, int n);
extern int PASCAL NEAR trRegTest_(int f, int n);
extern int PASCAL NEAR trRegUndent(int f, int n);
...
extern int PASCAL NEAR trRegIndent();
extern int PASCAL NEAR trRegTest_();
extern int PASCAL NEAR trRegUndent();
