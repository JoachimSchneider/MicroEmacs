...
extern VOID PASCAL NEAR unlist_screen(SCREEN_T *sp);
...
extern VOID PASCAL NEAR free_screen(SCREEN_T *sp);
...
#if VMS
extern void PASCAL NEAR expandargs(int *pargc, char ***pargv);
#endif
...
extern VOID PASCAL NEAR nextdown(int f, int n);
extern VOID PASCAL NEAR nextup(int f, int n);
...
#if VMS
extern void PASCAL NEAR expandargs();
#endif
...
extern int PASCAL NEAR grabnowait();
extern int PASCAL NEAR grabwait();
#if     DBCS
...
extern VOID PASCAL NEAR nextdown();
extern VOID PASCAL NEAR nextup();
