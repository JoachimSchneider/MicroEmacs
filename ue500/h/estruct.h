 ...
 *
 *                       (C)Copyright 1997 by Daniel Lawrence written by Daniel
 * Lawrence based on code by Dave G. Conroy, Steve Wilhite and George Jones
 */
/*====================================================================*/
/*       1         2         3         4         5         6         7*/
 ...
 * version. People using MicroEMACS as a shell for other products should change
 * this to reflect their product. Macros can query this via the $progname
 * variable
 */
...
#if     LATTICE & MSDOS
/* you may have to remove this one definition with LATTICE version 3.2 and above
 *                                                  */
# define unsigned
#endif
 ...
 * positions of upper to lower case letters is the opposite of ascii in ebcdic.
 */
 ...
 * text. The end of line is not stored as a byte; it's implied.
 */
typedef struct  LINE {
