/***
 *       MPE driver/Microemacs 3.10b/3.10k, Copyright 1995 D. Lawrence, C. Smith
 ***/
/** Include files **/
...
error_other: FCLOSE(mpetermout, 0, 0);
error_stdlist: FCLOSE(mpetermin, 0, 0);
error_stdin: return -1;
}
